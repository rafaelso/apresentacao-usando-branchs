...
\begin{figure}[h!]
\centering
{\fontsize{1cm}{1em}\selectfont Processo de atualização do esquema de banco do Cube}
\end{figure}
}

\frame{\frametitle{Contratempos} 
    \begin{itemize}
        \item perdemos o processo que tínhamos para atualização do esquema de
            banco do Cube;
        \newline
...
\frame{\frametitle{Proposta} 
    \begin{itemize}
        \item criar um repositório para abrigar os \textit{scripts} do Cube,
            facilitando o compartilhamento de alterações;
        \newline
        \item definir um processo de trabalho para manutenção dos
            \textit{scripts};
        \newline
        \item Colaboração entre equipes de Desenv e BD.
    \end{itemize}
}
...
\begin{figure}[h!]
\centering
{\fontsize{1cm}{1em}\selectfont Technical Reviews}
\end{figure}
}
